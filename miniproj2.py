...
def main():
	...
	print('Please follow the syntax: \'row number,column\' where row number is within the size of the board and column is A-E')
	...
	depth1 = int(input('Enter the maximum depth of the adversarial search for player1: '))
	depth2 = int(input('Enter the maximum depth of the adversarial search for player2: '))
	max_time = float(input('Enter the maximum allowed time for the program: '))

	print('Player \'X\' mode: ')
	player_x = input('Press 1 for AI, 2 for Human: ')
	if player_x == '1':
		algo1 = input('Press 0 for Minimax, 1 for Alphabeta')
	print('Player2 mode: ')
	mode2 = input('Press 1 for AI, 2 for Human: ')
	if mode2 == '1':
		algo2 = input('Press 0 for Minimax, 1 for Alphabeta')

    g = Game(board_size, blocks_num, blocks_pos, lineup_size, )
